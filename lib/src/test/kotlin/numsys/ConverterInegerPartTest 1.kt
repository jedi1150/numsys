...
internal class ConverterFractionalPartTest {
    private val nsBin = NumberSystem("10000000.011", Radix.BIN)
    private val nsOct = NumberSystem("200.3", Radix.OCT)
    private val nsDec = NumberSystem("128.375", Radix.DEC)
    private val nsHex = NumberSystem("80.6", Radix.HEX)
    private val ns36 = NumberSystem("3K.DI", Radix(36))
